...
const (
	...
	SvcUnavailable       Type = "SERVICE_UNAVAILABLE"    // For long running handlers
	UnsupportedMediaType Type = "UNSUPPORTED_MEDIA_TYPE" // for http 415
)

const (
	ERROR_MSG_EMPTY_REQ_BODY Type = "request body can not be empty"
)
...
// NewSvcUnavailable to create an error for 503
func NewSvcUnavailable() *Error {
	return &Error{
		Type:    SvcUnavailable,
		Message: fmt.Sprintf("Svc unavailable or timed out"),
	}
}
